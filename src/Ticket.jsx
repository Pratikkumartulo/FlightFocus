...
const Ticket = () => {
  ...
  return (
    <div className="w-full min-h-screen flex flex-col items-center bg-zinc-900">
      <section className="w-full flex-grow flex items-center justify-center p-2 sm:p-4">
        <div className="flex flex-col sm:flex-row w-full max-w-3xl text-zinc-900 h-auto sm:h-64">
          <div className="h-32 sm:h-full bg-white flex items-center justify-center px-4 sm:px-8 rounded-t-3xl sm:rounded-l-3xl sm:rounded-t-none">
            <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
				width="140px" height="140px" viewBox="0 0 232 232" enableBackground="new 0 0 232 232" xmlSpace="preserve">
				...
				<g transform="translate(16,16)">
					...
					</g><g transform="translate(80,0) scale(0.08,0.08)"><g transform="" style={{fill: "rgb(255, 255, 255)"}}>
				<rect width="100" height="100"/>
				...
				<rect width="100" height="100"/>
				</g></g><g transform="translate(24,152) scale(0.08,0.08)"><g transform="" style={{fill: "rgb(255, 255, 255)"}}>
				<rect width="100" height="100"/>
				</g></g><g transform="translate(32,152) scale(0.08,0.08)"><g transform="" style={{fill: "rgb(255, 255, 255)"}}>
				<rect width="100" height="100"/>
				</g></g><g transform="translate(40,152) scale(0.08,0.08)"><g transform="" style={{fill: "rgb(255, 255, 255)"}}>
				<rect width="100" height="100"/>
				</g></g><g transform="translate(48,152) scale(0.08,0.08)"><g transform="" style={{fill: "rgb(255, 255, 255)"}}>
				<rect width="100" height="100"/>
			...
			<div className="relative h-8 sm:h-full flex flex-row sm:flex-col items-center border-dashed justify-between border-2 bg-white border-zinc-900">
				<div className="absolute rounded-full w-8 h-8 bg-zinc-900 -top-5 hidden sm:block"></div>
				<div className="absolute rounded-full w-8 h-8 bg-zinc-900 -bottom-5 hidden sm:block"></div>
			</div>
			<div className="h-auto py-4 sm:py-8 px-4 sm:px-10 bg-white flex-grow rounded-b-3xl sm:rounded-r-3xl sm:rounded-b-none flex flex-col">
				<div className="flex flex-col sm:flex-row w-full justify-between items-center gap-4 sm:gap-0">
					<div className="flex flex-col items-center">
						<span className="text-2xl sm:text-4xl font-bold">{booking.departure?.iata || '---'}</span>
						<span className="text-zinc-500 text-xs sm:text-sm">{booking.departure?.name || 'Departure'}</span>
					</div>
					<div className="flex flex-col flex-grow items-center px-0 sm:px-10">
						<span className="font-bold text-xs">{booking.todo || '---'}</span>
						...
						<div className="flex items-center px-3 rounded-full bg-lime-400 h-8 mt-2">
							<span className="text-sm">{`${booking.hours}h ${booking.minutes}m`}</span>
						</div>
					</div>
					<div className="flex flex-col items-center">
						<span className="text-2xl sm:text-4xl font-bold">{booking.arrival?.iata || '---'}</span>
						<span className="text-zinc-500 text-xs sm:text-sm">{booking.arrival?.name || 'Arrival'}</span>
					</div>
				</div>
				<div className="flex w-full mt-auto justify-between flex-wrap gap-4 sm:gap-0">
					<div className="flex flex-col">
						<span className="text-xs text-zinc-400">Distance</span>
						<span className="font-mono">{booking.distance || '---'} km</span>
					</div>
					<div className="flex flex-col">
						<span className="text-xs text-zinc-400">Seat</span>
						<span className="font-mono">{booking.seat || '---'}</span>
					</div>
					<div className="flex flex-col">
						<span className="text-xs text-zinc-400">Task</span>
						<span className="font-mono">{booking.todo || '---'}</span>
					</div>
				</div>
			</div>
		</div>
	</section>
	{/* Confirm button below ticket */}
	<button className="w-full max-w-3xl mx-auto mb-8 px-6 py-3 bg-green-600 hover:bg-green-700 text-white font-bold rounded-lg text-base transition-colors"
    onClick={()=>{
        confirmBooking();
    }}
    >
	...
	<button className="w-full max-w-3xl mx-auto mb-8 px-6 py-3 bg-red-600 hover:bg-red-700 text-white font-bold rounded-lg text-base transition-colors"
    onClick={()=>{
        cancelBooking();
    }}
    >
